"""Hardware cards — status-striped panels with overlay hover."""

from ..ui_tokens import KYTH_HAIRLINE, KYTH_HAIRLINE_LIGHT, KYTH_RADIUS, KYTH_SURFACE, KYTH_SURFACE_RAISED, KYTH_TEXT_FAINT, STATUS_ERROR, STATUS_OK, STATUS_WARN
