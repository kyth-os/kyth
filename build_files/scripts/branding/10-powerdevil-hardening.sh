...
write_config /etc/environment.d/90-kyth-powerdevil.conf <<'POWERDEVILEOF'
POWERDEVIL_NO_DDCUTIL=1
POWERDEVILEOF
write_config /etc/xdg/plasma-workspace/env/90-kyth-powerdevil.sh 0755 <<'POWERDEVILSHEOF'
#!/bin/sh
export POWERDEVIL_NO_DDCUTIL=1
POWERDEVILSHEOF
write_config /etc/xdg/ddcutil/ddcutilrc <<'DDCUTILRCEOF'
[libddcutil]
