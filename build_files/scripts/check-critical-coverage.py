...
THRESHOLDS = {
    ...
    "build_files/kyth-installer/kyth_installer/plan.py": 65.0,
    "build_files/kyth-installer/kyth_installer/plan_commit.py": 90.0,
    ...
    "build_files/kyth-installer/kyth_installer/plan_validate.py": 70.0,
