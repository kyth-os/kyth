...
_DEFAULT_APP_DB: list[tuple[str, str, str, str | None]] = [
    ...
    ("code|vscode|visual.?studio.?code", "Visual Studio Code", "VS Code is available from the app menu or Kyth Hub.", None),
    ...
    ("resolve|davinci", "DaVinci Resolve", "Install DaVinci Resolve via Hub > Apps.", None),
    ...
    ("elgato|stream.?deck", "Elgato / Stream Deck", "Use OpenDeck from Hub > Apps for Stream Deck workflows.", None),
