...
| Applications | `install_flatpak`, `uninstall_flatpak`, `update_flatpaks`, AppImage import/chmod/launch, install status | mutate / read | App updates cover both user and system Flatpaks; system changes use the dedicated policy path. |
