...
confirmation gates, and fixed-route start/cancel/reboot/rescue calls. The
existing Tauri flow remains the compatibility path until manual partitioning,
configuration choices, and live event streaming have native parity.
