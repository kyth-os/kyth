...
| `system::preference_presets` | Fonts, locale, OOMD, immutable `/etc` overlay, Steam deadzone, and native SELinux gaming config dispatch | Desktop/system policy application and overlay activation remain outside Rust. |
