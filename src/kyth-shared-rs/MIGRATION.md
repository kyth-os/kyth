...
| `system::runtime_preferences` | Trim, UKSM, journald, IRQ, and FS-Cache config models plus reversible generated snippets and native trim-tune/uksmd dispatch | Service activation, CPU autodetection, and active filesystem/scheduler changes remain outside Rust. |
