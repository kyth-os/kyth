...
| `system::btrfs_autotune`, `overlay` | Btrfs autotune config/script and native Podman metacopy config/drop-in dispatch and rendering | Timer/service activation and filesystem/container runtime operations remain outside Rust. |
