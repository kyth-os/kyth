...
- **Native Rust dispatcher**: 93 (all 49 sysctl wrappers plus 44 other-kind wrappers); 1 other-kind wrapper remains on the compatibility dispatcher.
...
| 14 | kyth-fcitx-latency | fcitx_latency | other | fcitx latency | native Rust dispatcher |
...
| 19 | kyth-gaming-audit | perf_audit | other | gaming audit | native Rust dispatcher |
| 20 | kyth-gaming-cfs | gaming_cfs | other | `/etc/kyth/gaming-cfs.toml` | native Rust dispatcher |
| 21 | kyth-gaming-master | gaming_master | other | gaming-performance | native Rust dispatcher |
...
| 29 | kyth-kargs-apply | kargs_preset | other | kargs | native Rust dispatcher |
...
| 44 | kyth-perf-gate | perf_gate | other | perf gate | native Rust dispatcher |
