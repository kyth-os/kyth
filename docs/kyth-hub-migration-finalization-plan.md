...
points, 49 sysctl-backed tunable entries, and 43 module-specific tunable entries
are now native Rust/non-Python. The remaining 2 module-specific tunables still
...
- [x] Port the 49 sysctl-backed entries and 43 module-specific entries of the
...
- [ ] Port the remaining 2 module-specific tunable writers, remove the
...
| P2 | Port remaining indirect recipe executors (`kyth-tunable`) and remove its compatibility module. | 7 (49 sysctl and 43 module-specific entries complete 2026-09-03; 2 fallback entries remain) |
