...
points, 49 sysctl-backed tunable entries, and 37 module-specific tunable entries
are now native Rust/non-Python. The remaining 8 module-specific tunables still
...
- [x] Port the 49 sysctl-backed entries and 37 module-specific entries of the
...
- [ ] Port the remaining 8 module-specific tunable writers, remove the
...
| P2 | Port remaining indirect recipe executors (`kyth-tunable`) and remove its compatibility module. | 7 (49 sysctl and 37 module-specific entries complete 2026-09-03; 8 fallback entries remain) |
