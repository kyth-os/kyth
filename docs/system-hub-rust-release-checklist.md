...
or autostarted.
The native `kyth-tunable-rs` dispatcher now owns 71 of the 94 tunable entries;
the remaining 23 entries continue through the explicit compatibility fallback.
...
- [ ] Port the remaining 23 tunable entries whose writers are module-specific,
