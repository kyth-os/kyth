...
or autostarted.
The native `kyth-tunable-rs` dispatcher now owns 68 of the 94 tunable entries;
the remaining 26 entries continue through the explicit compatibility fallback.
...
- [ ] Port the remaining 26 tunable entries whose writers are module-specific,
