...
or autostarted.
The native `kyth-tunable-rs` dispatcher now owns 77 of the 94 tunable entries;
the remaining 17 entries continue through the explicit compatibility fallback.
...
- [ ] Port the remaining 17 tunable entries whose writers are module-specific,
