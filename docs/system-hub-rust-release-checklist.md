...
or autostarted.
The native `kyth-tunable-rs` dispatcher now owns 82 of the 94 tunable entries;
the remaining 12 entries continue through the explicit compatibility fallback.
...
- [ ] Port the remaining 12 tunable entries whose writers are module-specific,
