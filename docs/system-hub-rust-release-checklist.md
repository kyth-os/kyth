...
or autostarted.
The native `kyth-tunable-rs` dispatcher now owns 80 of the 94 tunable entries;
the remaining 14 entries continue through the explicit compatibility fallback.
...
- [ ] Port the remaining 14 tunable entries whose writers are module-specific,
